...
$positivados = $positivados2->PositAllG();
$notPosit = $positivados2->NotPositG();
            ...
            <div class="row">
                <div class="col">
                    <h1 class="s-24">
                        ...
                        POSITIVAÇÃO Geral<span class="s-14"> Mês de <?=$mes?></span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item" style=" display: grid; grid-template-columns: 1fr 6fr 1fr; align-content: center; padding: 10px; height:80px; background:#d6ecbd; border: solid 1px #f5f8fa">
                                ...
                                <div style="grid-column: 2"><strong class="font-weight-bold"> Cod.: <?= $value->ID ?></strong><br><strong> <?= $value->Nome_parceiro ?></strong></div>
