...
date_default_timezone_set('America/Cuiaba'); 
 ...
 if(isset($_GET['regiao'])){
     ...
     $consulta_acessos= $conn->prepare("SELECT c.nome, c.email, b.razao, a.* FROM financeiro a, clientes b, usuarios c 
where a.Cod_Cli = b.Cod_Cli and b.rca = c.rca and Cond_Pag in('z016','z859','z014') and a.Dt_Atraso > 0 and c.Regiao = '$regiao' order by a.Dt_Atraso DESC");
...
if(!isset($_GET['regiao'] )|| $regiao == 'Todos'){
 ...
 $consulta_acessos= $conn->prepare("SELECT c.nome, c.email, b.razao, a.* FROM financeiro a, clientes b, usuarios c
 where a.Cod_Cli = b.Cod_Cli and b.rca = c.rca and Cond_Pag in('z016','z859','z014') and a.Dt_Atraso > 0 order by a.Dt_Atraso DESC");
 $consulta_acessos->execute(array('id' => $id));
 $result_acessos= $consulta_acessos->fetchAll();
