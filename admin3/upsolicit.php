...
if($status == "Aprovado" || $status == "Recusado"){
    ...
    $atuaEncerra = $conn->prepare("UPDATE solicitacao set dt_encerrado = NOW(), cod_sap = $cod_sap WHERE cnpj = $cnpj2");
    $atuaEncerra -> execute();
}
...
$mail->addBCC('marciano@disnorteagil.com.br');
...
$mail->Subject = 'STATUS DE SUA SOLICITAÇÃO';
 ...
 <p style="font-family:Dosis; font-size: 20px; color: #335a67; "> Codigo do Cliente: <strong>'.$cod_sap.'</strong></p>
