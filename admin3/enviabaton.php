...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Subject = 'ACOMPANHAMETO POSITIVAÇÃO BATON';
        ...
        $consulta_tri= $conn->prepare("SELECT Cod_Cli,razao from clientes WHERE Cod_Cli NOT IN 
(select id from (SELECT a.VENDEDOR, a.ID, b.razao,a.MATERIAL IN ($bat)AS baton,
 a.Quantidade FROM $mes a, clientes b where a.vendedor = b.rca AND a.ID=b.Cod_Cli and a.MATERIAL
