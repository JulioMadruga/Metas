...
<html style="background: #737373;">
    <head>
        <meta charset="UTF-8">
        <title>Importação Clientes SAP</title>
...
if (isset($_POST['submit'])) {
   ...
   $deleterecords = "TRUNCATE TABLE clientes_sap"; //Esvaziar a tabela
   ...
   $limpa->execute();
    ...
    /*if (is_uploaded_file($_FILES['filename']['tmp_name'])) {
       ...
       $import2= $conn->prepare("SET GLOBAL local_infile = 1");
       $import2->execute();
       ...
       $import= $conn->prepare("LOAD DATA LOCAL INFILE '$nome'
          ...
          (cod_cli, razao, endereco, uf, cidade,bairro,cep,telefone,cnpj,insc,cod_canal,hierarquia)");
        // var_dump($import);
       $import->execute();
       $import->closeCursor();
