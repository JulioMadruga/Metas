...
for($i=0;$i<=6;$i++) {
    ...
    if($translate[$data->format('w')] == "Dom"){
        $domingo = $data->format('Y-m-d');
    }
...
$datahoje = $data2->format('w');


If ($datahoje>0 && $datahoje<6){
...
$as34 = [11320331,12396921];
$trad = [12415774,12396921,12396888,12312312,12365128,12365129];
