...
$usuario = $result[0]['nome'];
    ...
    $consulta_baton = $conn->prepare("SELECT super, rca, vendedor, COUNT(cod_cli) as posit FROM `p_baton` GROUP by vendedor Order by super, vendedor");
...
<!-- <td style="width: 150px; text-align: center; border: solid; border-color: #84071D;border-right-color: aliceblue;">Supervisor</td> -->
<td style="width: 100px; text-align: center; border: solid; border-color: #84071D;border-right-color: aliceblue;">Rca</td>
<td style="width: 300px; text-align: center; border: solid; border-color: #84071D;border-right-color: aliceblue;">Vendedor</td>
<td style="width: 100px; text-align: center; border: solid; border-color: #84071D;">Posit.</td>
