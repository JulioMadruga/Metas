...
<html style="background: #737373;">
    ...
    <div id="nav" class="col-lg-12"  style="background: #121415;">
        ...
        <div class="col-md-3"></div>  
            <div class="col-md-6" id="title" style="height: 70px; text-align:center; background-color:#c17308; font-family:Oswald; color:#F2FAFD;"> <h2>IMPORTAÇÃO DOS RESULTADOS POSITIVAÇÃO BISCOITOS</h2></div>
               <div class="col-md-3"></div>  
        </div>
...
if (isset($_POST['submit'])) {
   ...
   $deleterecords = "TRUNCATE TABLE posit_bisc"; //Esvaziar a tabela
   ...
   $limpa->execute();
    ...
    /*if (is_uploaded_file($_FILES['filename']['tmp_name'])) {
       ...
       $import->closeCursor();
        ...
        $delete = "DROP TABLE IF EXISTS p_bisc; "; //Esvaziar a tabela
        ...
        $import23= $conn->prepare("CREATE TABLE p_bisc SELECT a.cod_cli,a.razao,b.rca,b.vendedor,a.ordem,a.data_doc, c.super FROM `posit_bisc`a, clientes b, usuarios c where a.cod_cli = b.cod_cli and b.rca = c.Rca");
        // var_dump($import23);
        $import23->execute();
