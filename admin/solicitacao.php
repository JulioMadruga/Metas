...
<html>
   ...
   border: none;  border-bottom:solid; border-collapse: collapse; border-color: #245269; padding: 3px;
    ...
    <div id="nav" class="col-lg-12"  style="background: #121415;">
            ...
            if($usuario=="Julio" || $usuario=="Marciano"){?>
                ...
                <li class="button-dropdown"><a href="javascript:void(0)" class="dropdown-toggle"> Cadastros <span>▼</span>  </a>
                    <ul class="dropdown-menu">
                        ...
                        <li role="presentation" ><a href="#">Cad. Campanhas</a></li>
                        ...
                        if($usuario=="Julio" || $usuario=="Marciano"){
                            ...
                            echo '<li role="presentation" id="active"   ><a href="#">Solic. Cadastros</a></li>';
                        }
        ...
        <div id="logo" class="row" style="padding-top: 50px; background: #737373;">

        <div class="col-md-3" style="text-align:center; background-color:#074456; font-family:Oswald; color:#E4F3F7;height: 50px; padding-top: 5px;"><img src="../images/disnorte.png"></div>
        ...
        <div class="col-md-3" style="text-align:center; background-color:#074456; font-family:Oswald; color:#E4F3F7;"><img src="../images/garoto.png"></div>
    ...
    <div class="row" style=" background: #737373;">
        ...
        <div class="col-md-12" style="padding-top: 5px;background: aliceblue;text-align: center;">
            ...
            if(isset($_GET['status'])){
                ...
                if($estado == "Todos"  ){
                    ...
                    $consulta_Solicitacoes = $conn->prepare("Select a.rca, a.cnpj, a.razao, a.estado, a.obs, DATE_FORMAT(a.dataini ,'%d/%m/%Y') as dataini,
                                                         DATE_FORMAT(a.datafim ,'%d/%m/%Y')AS datafim, b.nome, a.obs, a.email, a.canal, a.cod_sap from solicitacao a, usuarios b where a.rca = b.rca ORDER BY a.estado DESC, a.dataini DESC  ");
                ...
                if(isset($_GET['rca'])){
                    ...
                    if(strlen($rca)<= 0){
                        ...
                        $consulta_Solicitacoes = $conn->prepare("Select a.rca, a.cnpj, a.razao, a.estado, a.obs, DATE_FORMAT(a.dataini ,'%d/%m/%Y') as dataini,
                                                         DATE_FORMAT(a.datafim ,'%d/%m/%Y')AS datafim, b.nome, a.obs, a.email, a.canal, a.contato,a.fone, a.cod_sap from solicitacao a, usuarios b where a.rca = b.rca and a.estado = '$estado' ORDER BY a.estado desc, a.dataini DESC  ");
                    ...
                    $consulta_Solicitacoes = $conn->prepare("Select a.rca, a.cnpj, a.razao, a.estado, a.obs, DATE_FORMAT(a.dataini ,'%d/%m/%Y') as dataini,
                                                         DATE_FORMAT(a.datafim ,'%d/%m/%Y')AS datafim, b.nome, a.obs, a.email, a.canal,a.contato,a.fone from solicitacao a, usuarios b where a.rca = b.rca and a.rca = $rca and a.estado = '$estado' ORDER BY a.estado desc, a.dataini DESC  ");
                    $consulta_Solicitacoes->execute();
                    $result_solicit = $consulta_Solicitacoes->fetchAll();
                    ...
                    $consulta_Solicitacoes = $conn->prepare("Select a.rca, a.cnpj, a.razao, a.estado, a.obs, DATE_FORMAT(a.dataini ,'%d/%m/%Y') as dataini,
                                                         DATE_FORMAT(a.datafim ,'%d/%m/%Y')AS datafim, b.nome, a.obs, a.email, a.canal,a.contato,a.fone from solicitacao a, usuarios b where a.rca = b.rca ORDER BY a.estado desc, a.dataini DESC  ");
                    $consulta_Solicitacoes->execute();
                    $result_solicit = $consulta_Solicitacoes->fetchAll();
               ...
               <table id="tblExport"  class="table-responsive" align="center" > 
               ...
               <th style="width: 250px; padding: 5px !important; border-left-color: aliceblue; border:solid;">CLIENTE</th>
          
               <th style="width: 180px;padding: 5px !important; border-left-color: aliceblue; border:solid;">CNPJ</th>
               
               <th style="width: 160px;padding: 5px !important; border-left-color: aliceblue; border:solid;">EMAIL</th>
               
                <th style="width: 80px;padding: 5px !important; border-left-color: aliceblue; border:solid;">CANAL</th>
                
                <th style="width: 80px;padding: 5px !important; border-left-color: aliceblue; border:solid;">CONTATO</th>
               
                <th style="width: 80px;padding: 5px !important; border-left-color: aliceblue; border:solid;">FONE</th>
          
               <th style="width: 100px;padding: 5px !important; border-left-color: aliceblue; border:solid;">STATUS</th>
               
               <th style="width: 300px;padding: 5px !important; border-left-color: aliceblue; border:solid;">OBSEVAÇÕES</th>
               ...
               foreach ($result_solicit as $row){
                   ...
                   if($row[3] == "Pendente") {
                       ...
                       echo "<td style='width: 250px; padding: 5px !important; font-weight: bold'>" . $row[2] . "</td>";
                       echo "<td style='width: 180px; padding: 5px !important;'>" . $row[1] . "</td>";
                       echo "<td style='width: 160px; padding: 5px !important;'>" . $row[9] . "</td>";
                       echo "<td style='width: 80px; padding: 5px !important;'>" . $row[10] . "</td>";
                       echo "<td style='width: 80px; padding: 5px !important;'>" . $row[11] . "</td>";
                       echo "<td style='width: 80px; padding: 5px !important;'>" . $row[12] . "</td>";
                      ...
                      style='width: 100px'>" . $row[3] . "</button></td>";
                       ...
                       echo "<td style='width: 300px; padding: 5px !important;'>" . $row[4] . "</td>";
                   ...
                   if($row[3] == "Em andamento") {
                      ...
                      style='width: 100px'>" . $row[3] . "</button></td>";echo "<td style='width: 300px; padding: 5px !important;'>" . $row[4] . "</td>";
                       echo "<td style='width: 90px; padding: 5px !important;'>" . $row[5] . "</td>";
                       echo "<td style='width: 90px; padding: 5px !important;'>" . $row[6] . "</td>";
                ...
                <div class="modal-body">
                    <form action="upsolicit.php?cnpj=<?php print $rca; ?>" method="post" name="form">
                        ...
                        <div class="form-group" style ="padding-top:15px">
                            <label for="recipient-name" class="control-label">Codigo SAP:</label>
                            <input type="text" class="form-control" id="cod_sap" name="cod_sap">
                        </div>
