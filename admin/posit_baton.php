...
<html style="background: #737373;">
    ...
    <div id="nav" class="col-lg-12"  style="background: #121415;">
        ...
        <div class="col-md-3"></div>  
            <div class="col-md-6" id="title" style="height: 70px; text-align:center; background-color:#a50c0c; font-family:Oswald; color:#F2FAFD;"> <h2>IMPORTAÇÃO DOS RESULTADOS POSITIVAÇÃO BATON</h2></div>
               <div class="col-md-3"></div>  
        </div>
   ...
   $limpa->execute();
    ...
    /*if (is_uploaded_file($_FILES['filename']['tmp_name'])) {
       ...
       $import->closeCursor();
        ...
        $delete = "DROP TABLE IF EXISTS p_baton; "; //Esvaziar a tabela
        ...
        $import23= $conn->prepare("CREATE TABLE p_baton SELECT a.cod_cli,a.razao,b.rca,b.vendedor,a.ordem,a.data_doc, c.super FROM `posit_baton`a, clientes b, usuarios c where a.cod_cli = b.cod_cli and b.rca = c.Rca");
        // var_dump($import23);
        $import23->execute();
