...
$consulta_metatri = $conn->prepare("SELECT c.Rca, c.nome as vendedor, c.email, d.Email, d.nome, b.razao, a.* FROM financeiro a, clientes b, usuarios c, supervisor d
 where a.Cod_Cli = b.Cod_Cli and b.rca = c.rca and c.Rca = d.RCA and a.Dt_Atraso > 4 GROUP by c.nome");
...
$result_cli= $consulta_metatri->fetchAll();
    ...
    //$mail->SMTPDebug = 3;                               // Enable verbose debug output
        ...
        $mail->Host = 'mail.disnorteagil.com.br';  // Specify main and backup SMTP servers
        $mail->SMTPAuth = true;                               // Enable SMTP authentication
        $mail->Username = 'julio@disnorteagil.com.br';                 // SMTP username
        $mail->Password = 'Juli2020';                           // SMTP password
...
//    $mail->addCC('raoni.cba@disnorteagil.com.br','Raoni');
    ...
    $mail->Subject = 'CLIENTE COM FATURAS EM ABERTO';
        ...
        $consulta_tri = $conn->prepare("SELECT c.nome, c.email, b.razao, a.* FROM financeiro a, clientes b, usuarios c
        where a.Cod_Cli = b.Cod_Cli and b.rca = c.rca and a.Dt_Atraso > 4 and 
...
<p style="font-family:Dosis; font-size: 20px; color: #335a67; ">Ol&aacute; <strong style="color: #164c5d; "> '.str_replace('VG','',str_replace('CBA','',$row{'vendedor'})).'</strong> Segue list de cliente com debitos. Temos que receber esta semana ainda senão será assumito pela empresa!</p>
