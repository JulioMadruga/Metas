...
if(!isset($_GET['regiao'] )|| $regiao == 'Todos'){
        ...
        $consulta_totalmeta= $conn->prepare("SELECT ROUND(SUM(valor), 2) as Total FROM $meta");
...
Meta Bisc. Recheados </div>

 <div class="chart" style="color: #05cae0; margin-top: 80px;" data-percentage="<?php echo '10'; ?>">
  <div class="percentage"></div>
